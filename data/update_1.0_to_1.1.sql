...
INSERT INTO `design_tables` (`interface_name`, `table_name`, `table_type`, `col_name`, `caption_style`, `row_type`, `col_por`, `pole_spisok_sql`, `pole_global_const`, `pole_prop`, `pole_type`, `pole_style`, `pole_name`, `default_sql`, `functions_befo`, `functions_after`, `functions_befo_out`, `functions_befo_del`, `properties`, `value`, `validator`, `sort_item_flag`, `col_function_array`) VALUES 
  ...
  ('stream', 'stream', 0, '', '', 1, 0, '', '', 'onChange=this.form.submit()', '4', '', '', '', '', '', 'Mf\\Stream\\Lib\\Func\\GetStatus', '', 'a:3:{i:0;s:1:\"0\";i:1;s:1:\"0\";i:2;s:1:\"0\";}', '', '', 0, NULL),
  ...
  ('stream', 'stream', 0, 'foto', '', 2, 7, '', NULL, '', '32', NULL, 'foto', NULL, '\\Mf\\Stream\\Lib\\Func\\InImgLib', '', '', '', 'a:2:{i:0;s:0:\"\";i:1;s:0:\"\";}', '', 'N;', NULL, 'N;'),
  ...
  ('stream_detal', 'stream', 0, 'seo_options', '', 2, 11, '', NULL, '', '1', NULL, '', NULL, '', '', '', '', 'a:2:{i:0;s:1:\"0\";i:1;s:1:\"0\";}', '', 'N;', NULL, 'N;'),
  ('stream_detal', 'stream', 0, 'seo_options', '', 3, NULL, '', NULL, '', '24', NULL, 'seo_options', NULL, '', '', '', '', 'N;', '', 'N;', NULL, 'N;'),
